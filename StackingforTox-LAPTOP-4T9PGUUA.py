...
class toxPredict(object):
    ...
    def forPredict(self):
        ...
        predictCAS = ['10034-81-8','10141-05-6','1067-14-7','110-50-9','1118-46-3','1120-44-1','12264-18-5','123-46-6','12715-61-6','128-04-1','1302-42-7','1305-62-0','1313-27-5','1333-82-0','13390-47-1','13464-37-4','13510-49-1','13701-59-2','13826-65-8','13939-25-8','144-55-8','145-73-3','14644-61-2','150-75-4','15339-36-3','17095-24-8','22228-82-6','2465-27-2','2682-20-4','2787-91-9','28801-69-6','301-04-2','3567-25-7','3590-84-9','4779-86-6','513-78-0','51580-86-0','53404-23-2','569-64-2','6148-75-0','631-61-8','6369-97-7','6980-18-3','71751-41-2','7250-67-1','7440-36-0','7440-62-2','7487-94-7','7631-99-4','76930-58-0','7699-45-8','7775-19-1','7790-86-5','7803-57-8','79-57-2','8022-00-2','8065-48-3','81510-83-0']
        df = pd.read_csv('metalMACCS.csv').set_index('CAS')
        names = ['fish_tox','daphnia_tox','Algae_tox']
        for name in names:
            if name == 'fish_tox':
            ...
            for c,i in zip(test_X.index,predict):
                print(c,i)
    ...
    def sepData(self):
        ...
        test_index = [12,14,21,31,34,37,48,52,64,75,85,90,92,171,172,181,188,206
,224,225,262,278,285,303,310,315,329,330,332,347,348,354,355,356,357,358
,375,384,390,432,447,452,462,479,481,485,491,500,501,506,513,518,520,530
,549,550,566,569]
